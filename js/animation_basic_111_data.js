const uri = 'https://sheets.googleapis.com/v4/spreadsheets/1E7gWckeGt2znBdnp8mXFG2cPMvk9qrbJJIpyla0VW6o/values/animation-basic-111?alt=json&key=AIzaSyChSjLDxCjYXAGKruUaNl4ErzdHsc1wBAI';
...
fetch(uri)
 ...
 // RWD Md
    ...
    let thought =  `<a class="list-group-item m-3 h5 border-0 list-group-item-action" href="#thoughts-title">${d[9]}</a>`;

    document.querySelector('#class-menu-items-md').insertAdjacentHTML('beforeend', thought);

   
    let review =  `<a class="list-group-item m-3 h5 border-0 list-group-item-action" href="#review-title">${d[10]}</a>`;
    ...
    let thought =  `<a class="nav-link list-group-item m-xl-3 h5 border-0 list-group-item-action"" href="#thoughts-title">${d[9]}</a>`;

    document.querySelector('#class-menu-items-lg').insertAdjacentHTML('beforeend', thought);

   
    let review =  `<a class="nav-link list-group-item m-xl-3 h5 border-0 list-group-item-action"" href="#review-title">${d[10]}</a>`;
